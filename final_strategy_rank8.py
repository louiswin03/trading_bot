"""
FINAL OPTIMIZED STRATEGY - RANK 8 v2 + Trailing SL
Configuration optimale avec Trailing SL dynamique
...
def backtest(df, initial_capital=INITIAL_CAPITAL):
    """Run backtest with RANK 8 parameters"""
...
def generate_html_report(df, trades, capital, max_dd, equity_df):
    ...
    fig.update_layout(height=1400, showlegend=True, title_text="FINAL STRATEGY RANK 8 v2 + Trailing SL - Backtest Report")
    ...
    <html>
    <head>
        <title>Strategy RANK 8 - Backtest Report</title>
        <style>
            ...
            .parameters {{ background: #3498db; color: white; padding: 20px; border-radius: 8px; margin: 20px 0; }}
    ...
    <body>
        <div class="container">
            <h1>🏆 FINAL STRATEGY RANK 8 - Backtest Results</h1>
...
def main():
    print("\n" + "="*100)
    print("FINAL STRATEGY RANK 8 v2 + TRAILING SL - BACKTEST")
    print("="*100)
    ...
    output_file = "final_strategy_rank8_backtest.html"
