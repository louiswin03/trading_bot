"""
FINAL OPTIMIZED STRATEGY - RANK 8 v2 + Trailing SL - 10% CAPITAL VERSION
Version avec 10% du capital par trade (au lieu de 98%)

Changements par rapport à la version originale:
- Position size: 10% du capital par trade (au lieu de 98%)
- Compounding reste actif (le capital augmente avec les gains)
"""
...
# MODIFICATION: 10% du capital par trade (au lieu de 98%)
...
def backtest(df, initial_capital=INITIAL_CAPITAL):
    """Run backtest with RANK 8 parameters - 10% CAPITAL VERSION"""
    ...
    for i in range(55, len(df) - 1):
        ...
        if not in_trade:
            ...
            if bullish_trend or bearish_trend:
                ...
                # MODIFICATION: 10% du capital au lieu de 98%
...
def generate_html_report(df, trades, capital, max_dd, equity_df):
    ...
    fig.update_layout(height=1400, showlegend=True, title_text="RANK 8 v2 - 10% CAPITAL - Backtest Report")
    ...
    <html>
    <head>
        <title>Strategy RANK 8 - 10% CAPITAL - Backtest Report</title>
        <style>
            ...
            .parameters {{ background: #27ae60; color: white; padding: 20px; border-radius: 8px; margin: 20px 0; }}
    ...
    <body>
        <div class="container">
            <h1>RANK 8 - 10% CAPITAL VERSION - Backtest Results</h1>

            <div class="parameters">
                <h2>Strategy Parameters (10% CAPITAL VERSION)</h2>
                ...
                <p style="margin-top: 15px; border-top: 1px solid rgba(255,255,255,0.3); padding-top: 15px;">
                    ...
                    Position Size: {POSITION_SIZE_PCT*100}% du capital par trade (au lieu de 98%)<br>
                    Compounding actif: Le capital augmente avec les gains
                </p>
            </div>
...
def main():
    print("\n" + "="*100)
    print("RANK 8 v2 + TRAILING SL - 10% CAPITAL VERSION - BACKTEST")
    print("="*100)
    ...
    print(f"\n[!] MODIFICATION: Position Size = {POSITION_SIZE_PCT*100}% du capital (au lieu de 98%)")
    print("    Compounding actif: Le capital augmente avec les gains")
    print("\nFetching data...")
    ...
    print("\n" + "="*100)
    print("RESULTS - 10% CAPITAL VERSION")
    print("="*100)
    ...
    output_file = "final_strategy_rank8_10pct_backtest.html"
